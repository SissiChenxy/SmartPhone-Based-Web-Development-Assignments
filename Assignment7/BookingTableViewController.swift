...
//        self.navigationController?.show(vc, sender: self)
        ...
        vc.booking = Booking.FindBooking(id: AppDelegate.BookingList[indexPath.row].id)!
    ...
    override func tableView(_ tableView: UITableView, accessoryButtonTappedForRowWith indexPath: IndexPath) {
        _ = (AppDelegate.BookingList[indexPath.row].movie?.name)! + (AppDelegate.BookingList[indexPath.row].customer?.name)!
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let vc = storyboard.instantiateViewController(withIdentifier: "BookingDetailVC") as! BookingDetailViewController
        self.navigationController?.show(vc, sender: self)
        vc.title = "Edit Booking Details"
