...
//  Assignment8
//
//  Created by Tianli Feng on 3/24/19.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let m1 = Movie(Name:"Bohemian Rhapsody", ReleaseYear: 2018, Type:"Music", Quantity:5, Image:UIImage(named: "bohemian.jpg")!)
        let m2 = Movie(Name:"Captain Marvel", ReleaseYear: 2018, Type:"Action", Quantity:3,Image:UIImage(named: "captain_marvel.jpg")!)
        let m3 = Movie(Name:"Bumble Bee", ReleaseYear: 2018, Type:"Adventure", Quantity:5,Image:UIImage(named: "bumblebee.jpg")!)
        let m4 = Movie(Name:"Superman", ReleaseYear: 1978, Type:"Adventure", Quantity:6,Image:UIImage(named: "superman.jpg")!)
        let m5 = Movie(Name:"Aquaman", ReleaseYear: 2018, Type:"Adventure", Quantity:1,Image:UIImage(named: "aquaman.jpeg")!)
